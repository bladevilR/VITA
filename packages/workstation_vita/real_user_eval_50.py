...
CASE_PATH = ROOT / "real_user_eval_50_cases.json"
REPORT_PATH = ROOT / "REAL_USER_EVAL_50_REPORT.md"
JSON_PATH = ROOT / "REAL_USER_EVAL_50_RESULTS.json"
...
def main() -> int:
    ...
    print(f"开始跑 50 条真实用户问法回归，时间：{started_at:%Y-%m-%d %H:%M:%S}")
