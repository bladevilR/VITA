...
class AIClient:
    ...
    def call_llm_text(self, prompt: str, temperature: float = 0.2, timeout: int = 90) -> str:
        payload = {
    ...
    def call_llm_json(self, prompt: str, temperature: float = 0.0, timeout: int = 90) -> dict[str, Any]:
        text = self.call_llm_text(prompt=prompt, temperature=temperature, timeout=timeout)
